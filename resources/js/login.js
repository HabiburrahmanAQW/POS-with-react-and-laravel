                ...
                <div className="w-96 rounded-3xl bg-white shadow-xl overflow-hidden z-10 opacity-100 scale-100">
                    <div className="text-left w-full text-sm p-6 overflow-auto">
                        <div className="text-center mb-5">
                            ...
                            <h2 className="text-xl font-semibold">ACT POS</h2>
                            <p>CABANG SUNAGARA</p>
                        </div>
                        {error !== "" && (
                            <div
                        ...
                        <form id="login-form" onSubmit={handleSubmit}>
                            <div className="flex flex-col mb-4">
                                <label
                                    className="mb-2 uppercase font-semibold text-sm text-grey-darkest"
                                    htmlFor="username"
                                >
                                    Username
                                </label>
                                <input
                                    ref={usernameRef}
                                    className="border py-2 px-3 text-grey-darkest rounded"
                                    type="text"
                                    name="username"
                                    id="username"
                                />
                    ...
                    <div className="p-4 w-full">
                        <button
                            form="login-form"
                            disabled={loading}
                            className="bg-cyan-500 text-white text-lg px-4 py-3 rounded-2xl w-full focus:outline-none hover:bg-cyan-700"
                        >
